...
The survey paradigm, a copy of the original survey paradigm, can be found [on Qualtrics](https://stanforduniversity.qualtrics.com/jfe/form/SV_2tzxxFTwuupTmEl). The only change was that in demographics, participants were asked for their age instead of DOB out of concerns about identifiable information.
...
The original study recruited participants from both Amazon Mechanical Turk and a university subject pool. In this replication, participants will only be recruited from Amazon Mechanical Turk for convenience. This change in the sample is not predicted to affect the result of the replication, since participants on Amazon Mechanical Turk behave similarly to participants in university subject pools. In addition, in the demographics section, participants were asked for their age instead of their date of birth out of concerns about identifiable information. This change should have no affect on the result, since demographics is the final task and no analysis was performed on demographic information.
